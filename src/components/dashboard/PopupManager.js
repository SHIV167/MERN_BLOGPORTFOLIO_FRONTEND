      ...
      <Table variant="simple" mb={8}>
        ...
        <Tbody>
          {popups.map(popup => (
            <Tr key={popup._id}>
              <Td>{popup.title}</Td>
              <Td>{popup.imageDesktop && <Image src={popup.imageDesktop.startsWith('http') ? popup.imageDesktop : `${baseUrl}${popup.imageDesktop}`} maxH="40px" />}</Td>
              <Td>{popup.imageMobile && <Image src={popup.imageMobile.startsWith('http') ? popup.imageMobile : `${baseUrl}${popup.imageMobile}`} maxH="40px" />}</Td>
              <Td>
      ...
      {current && (
        <Box bg="gray.50" borderRadius="md" p={6} mb={6} boxShadow="md">
          <VStack spacing={5} align="stretch">
            ...
            {current?.imageDesktop && <Image src={current.imageDesktop.startsWith('http') ? current.imageDesktop : `${baseUrl}${current.imageDesktop}`} maxH="120px" borderRadius="md" />} 
            <HStack>
            ...
            {current?.imageMobile && <Image src={current.imageMobile.startsWith('http') ? current.imageMobile : `${baseUrl}${current.imageMobile}`} maxH="120px" borderRadius="md" />}
            <HStack>
